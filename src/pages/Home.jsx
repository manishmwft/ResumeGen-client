      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <img
              src="logo.webp" // Replace this with your logo's file path
              alt="Logo"
              className="h-8" // Adjust height as needed
            />
            <span className="text-white">&nbsp;&nbsp;ResumeCraft</span>
          </div>
        ...
        <div className="bg-neutral-900">
          <div className="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24 text-center">
            <h1 className="font-semibold text-white text-5xl md:text-5xl ">
              <span className="text-[#ff0]">ResumeCraft :</span> Transforming Career Aspirations into Professional Resumes
            </h1>
            <div className="max-w-4xl ">
              <p className="mt-5 text-neutral-400 text-2xl ml-[14%] ">
              ResumeCraft is a hassle-free platform where you can create stunning resumes in minutes. Whether you're a fresher or a seasoned professional, ResumeCraft empowers you to design personalized, professional resumes tailored to your unique journey — no registration required.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-neutral-900 bg-gradient-to-t from-black to-transparent">
          <div className="max-w-5xl px-4 xl:px-0 py-24 mx-auto">
            ...
            <div className="max-w-3xl mb-10 lg:mb-14">
              ...
              Thousands of professionals trust us to create their dream resumes. Discover how ResumeCraft helped users stand out in the competitive job market and achieve career success.
              </p>
            </div>
            {/* End Title */}
            {/* Card Grid */}
            <div className="grid grid-cols-1 lg:grid-cols-3 items-center border border-neutral-700 divide-y lg:divide-y-0 lg:divide-x divide-neutral-700 rounded-xl">
              ...
              >
                <div className="mb-5">
                  ...
                  <div className="mt-5">
                    ...
                    <p className="mt-1 text-neutral-400">
                    With customized templates and optimized designs, ResumeCraft users experienced a 70% surge in job interview calls. Tailored sections and professional layouts made their profiles instantly appealing to recruiters.
                    Case study
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="mb-5">
                  ...
                  <div className="mt-5">
                    <p className="font-semibold text-5xl text-white">85%</p>
                    <h3 className="mt-5 font-medium text-lg text-white">
                    Time Saved in Resume Creation
                    </h3>
                    <p className="mt-1 text-neutral-400">
                    Our user-friendly platform eliminated complexity, enabling users to create polished resumes in under 10 minutes. No design skills required — just focus on your details, and we handle the rest!
                    Case study
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="mb-5">
                  ...
                  <div className="mt-5">
                    ...
                    <p className="mt-1 text-neutral-400">
                      {" "}
                      From students to senior executives, ResumeCraft has helped users create resumes they’re proud of. With effortless editing and instant PDF downloads, our platform consistently delivers.
Case study
                    </p>
                  </div>
                </div>
        ...
        <div className="bg-neutral-900">
          <div className="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
            ...
            <div className="max-w-3xl mb-10 lg:mb-14">
              ...
              <p className="mt-1 text-neutral-400">
              With a mission to empower users with professional, ready-to-download resumes, we proudly showcase our impact on countless careers and job-seeking journeys.
              </p>
            </div>
            {/* End Title */}
            {/* Grid */}
            <div className="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
              <div>
                ...
                <blockquote>
                  ...
                  "Switching to this Resume Builder was a game-changer. I landed my dream job within weeks of using their templates. Simple, effective, and seamless!"
                  </p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 items-center gap-y-20 gap-x-12">
                  ...
                  <div className="relative text-center first:before:hidden before:absolute before:-top-full sm:before:top-1/2 before:start-1/2 sm:before:-start-6 before:w-px before:h-20 before:bg-neutral-800 before:rotate-[60deg] sm:before:rotate-12 before:transform sm:before:-translate-y-1/2 before:-translate-x-1/2 sm:before:-translate-x-0 before:mt-3.5 sm:before:mt-0">
                    ...
                    <div className="mt-3 sm:mt-5">
                      ...
                      Resumes generated effortlessly
                      </p>
                    </div>
                  </div>
                  {/* End Stats */}
                  ...
                  <div className="relative text-center first:before:hidden before:absolute before:-top-full sm:before:top-1/2 before:start-1/2 sm:before:-start-6 before:w-px before:h-20 before:bg-neutral-800 before:rotate-[60deg] sm:before:rotate-12 before:transform sm:before:-translate-y-1/2 before:-translate-x-1/2 sm:before:-translate-x-0 before:mt-3.5 sm:before:mt-0">
                    ...
                    <div className="mt-3 sm:mt-5">
                      ...
                      <p className="mt-1 text-sm sm:text-base text-neutral-400">
                      Successful job placements through our templates
                      </p>
                    </div>
                  </div>
                  {/* End Stats */}
        ...
        <div className="bg-neutral-900">
          ...
          <div className="max-w-5xl px-4 xl:px-0 py-10 lg:pt-20  mx-auto">
            ...
            <div className="max-w-3xl mb-10 lg:mb-14">
              ...
              <p className="mt-1 text-neutral-400">
              Our streamlined process ensures that crafting the perfect resume is both simple and effective. From understanding your professional background to delivering a polished PDF, we focus on every step to help you stand out.
              </p>
            </div>
            {/* End Title */}
            {/* Grid */}
                ...
                <div className="flex gap-x-5 ms-1">
                  ...
                  <div className="grow pt-0.5 pb-8 sm:pb-12">
                    <p className="text-sm lg:text-base text-neutral-400">
                      ...
                      User-Friendly Details Collection :&nbsp;
                      </span>
                      Effortlessly input your personal and professional details in an intuitive and guided interface
                    </p>
                  </div>
                  {/* End Right Content */}
                </div>
                ...
                <div className="flex gap-x-5 ms-1">
                  ...
                  <div className="grow pt-0.5 pb-8 sm:pb-12">
                    <p className="text-sm lg:text-base text-neutral-400">
                      ...
                      Choose from a range of professional resume templates designed to match your career goals and industry.
                    </p>
                  </div>
                  {/* End Right Content */}
                </div>
                ...
                <div className="flex gap-x-5 ms-1">
                  ...
                  <div className="grow pt-0.5 pb-8 sm:pb-12">
                    <p className="text-sm md:text-base text-neutral-400">
                      ...
                      Instantly preview your resume as you build it, ensuring it meets your expectations at every step.
                    </p>
                  </div>
                  {/* End Right Content */}
                </div>
                ...
                <div className="flex gap-x-5 ms-1">
                  ...
                  <div className="grow pt-0.5 pb-8 sm:pb-12">
                    <p className="text-sm md:text-base text-neutral-400">
                      ...
                      Download your professional resume in PDF format with just a click—no registration required!
                    </p>
                  </div>
                  {/* End Right Content */}
                </div>
            ...
            autofill:pb-2"
              ...
              <div className="space-y-14">
                ...
                <div className="flex gap-x-5">
                  ...
                  <div className="grow">
                    <h4 className="text-white font-semibold"> ResumeCraft</h4>
                    <p className="mt-1 text-neutral-400">
                    We specialize in turning your details into impactful resume templates that you can customize, preview, and download instantly. Start crafting your dream resume today with ease and confidence
                    </p>
                    <p className="mt-2">
                      {/* <a
    ...
    <span className="text-white">&nbsp;&nbsp;ResumeCraft</span>
              ...
              <div className="border-s border-neutral-700 ps-5 ms-5">
                <p className="text-sm text-neutral-400">2024  ResumeCraft Co.</p>
              </div>
            </div>
          </div>
        </div>
