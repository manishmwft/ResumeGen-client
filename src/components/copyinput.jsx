...
function Input() {
  ...
  const handleNext = () => {
    setCurrentStep((prev) => Math.min(prev + 1, 3)); // 3 is the total number of steps
  };
  ...
  const checkboxFunc = (e, index) => {
    ...
    if (i === false && checked === true) {
      ...
      Setpresent(present.map((value, i) => (value === index ? "" : value)));
    }
  };
  ...
  const graderadioFunc = (e, index) => {
    ...
    if (i === false && e.target.value === "grade") {
      ...
      Setgrade(grade.map((val, i) => (val === index ? "" : val)));
    }
  };
    ...
    <>
      {loading ? (
        ...
        <>
          ...
          <div className="input-main shadow-lg pb-4">
            <form className="input-form" onSubmit={handleSubmit(onSubmit)}>
              ...
              />
              <input
                {...register("personal.city", { required: true })}
                placeholder="City"
              />
              <input
                {...register("personal.country", { required: true })}
                placeholder="Country"
              />
              <input
              ...
              />
              <input
                {...register("personal.quote", { required: true })}
                placeholder="Describe yourself in one or two line"
              />
              <div className="singlefield form-img">
                <input
                  type={"url"}
                  {...register("personal.image", { required: true })}
                  placeholder="Paste your image url"
                />
                <div
                  onMouseEnter={() => Sethint("hint")}
                  onTouchEnd={() => Sethint("hint-hide")}
                  onTouchStart={() => Sethint("hint")}
                  onMouseLeave={() => Sethint("hint-hide")}
                >
                  i
                </div>
                <div className={hint}>
              ...
              <div className="input-interest">
                {interestFields.map((item, index) => {
                  return (
                    <div key={item.id}>
                      <input
                        {...register(`personal.interest[${index}].hobbie`, {
                          required: true,
                        })}
                      ...
                      {index !== 0 ? (
                        <RiCloseFill
                          onClick={() => {
                            interestRemove(index);
                          }}
                          className="interest-cls-icon"
                        />
                      ) : null}
                    </div>
                  );
              ...
              {technicalFields.map((item, index) => {
                return (
                  <React.Fragment key={item.id}>
                    <input
                      {...register(`personal.technicalskill[${index}].skill`, {
                        required: true,
                      })}
                    ...
                    <input
                      ...
                      min="0"
                      max="10"
                      {...register(`personal.technicalskill[${index}].rate`, {
                        required: true,
                      })}
              ...
              {experienceFields.map((item, index) => {
                return (
                  <React.Fragment key={item.id}>
                    ...
                    <input
                      {...register(`experience[${index}].worktitle`)}
                    ...
                    <input
                      ...
                      placeholder="Description about your work in one or two line"
                    />
                    <input
                      className="singlefield"
                      {...register(`experience[${index}].tags`)}
                    ...
                    <div className="year">
                      <input
                        name="year"
                        inputMode={"numeric"}
                        {...register(`experience[${index}].yearfrom`)}
                      ...
                      {!present.includes(index) ? (
                        <>
                          ...
                          <input
                            name="year"
                            inputMode={"numeric"}
                            {...register(`experience[${index}].yearto`)}
                      ...
                      <input
                        ...
                        onChange={(e) => checkboxFunc(e, index)}
                      />
              ...
              {courseFields.map((item, index) => {
                return (
                  <React.Fragment key={item.id}>
                    <div className="input-index">{index + 1}.</div>
                    <input
                      {...register(`course[${index}].name`)}
                      defaultValue={item.name}
                      placeholder="Course/Certificate Name"
                    />
                    <input
                      {...register(`course[${index}].provider`)}
                  ...
                  <React.Fragment key={item.id}>
                    ...
                    <div className="edu-grade">
                      ...
                      {eduerror[index]?.gradetype ? (
                        <div
                          className="input-err"
                          style={{ gridColumn: "1/4", fontWeight: "400" }}
                        >
                    ...
                    <div className="year">
                      <input
                        name="year"
                        inputMode={"decimal"}
                        {...register(`education[${index}].yearfrom`, {
                          required: true,
                        })}
                      ...
                      <input
                        name="year"
                        inputMode={"numeric"}
                        {...register(`education[${index}].yearto`, {
                          required: true,
                        })}
              ...
              <input
                {...register("link.linkedin", { required: true })}
              ...
              <input
                ...
                placeholder="Porfolio Url or any other (Optional)"
              />

              {errors.personal || errors.education ? (
                <span className="input-err singlefield">
              ...
              {userredux.personal ? (
                ...
                <input
                  className="input-btn singlefield mt-3"
                  type="submit"
                  value={"Next"}
                />
              )}
