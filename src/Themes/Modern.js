...
function Modern() {
  ...
  const themeclr = useSelector((state) => state.theme?.theme?.color) || "black";
          ...
          <div className="theme5">
            <div className="theme5-sec">
              ...
              <div>
                <div
                  className={"text-3xl"}
                  style={{ fontWeight: "bold", color: themeclr }}
                >
                  {userdata.personal.name} {userdata.personal.lastname}
                </div>
                <div
                  className={"font-semibold"}
                  style={{ color: themeclr, fontSize: "15px" }}
                >
            ...
            {userdata.experience[0].company ? (
              <div className="theme5-sec">
                <div
                  style={{ backgroundColor: themeclr, color: "white" }}
                ></div>
            ...
            {userdata.course[0].name ? (
              <div className="theme5-sec">
                ...
                <div className="theme5-head-sec">
                  <div style={{ backgroundColor: themeclr }}>
                    <RiMedalLine style={{ color: "white", fontSize: "18px" }} />
                  </div>
                  <div className="theme5-head" style={{ color: themeclr }}>
                ...
                {skillstyle === "style1" ? (
                  ...
                  >
                    {userdata.personal.technicalskill.map((item, index) => {
                      return (
                        <div key={index}>
                          <div style={{ color: themeclr, fontSize: "14px" }}>
                            {item.skill}
                          </div>
              ...
              <div className="theme5-content-sec">
                ...
                >
                  {userdata.personal.interest.map((item, index) => {
                    return (
                      <li key={index} style={{ listStyle: "inside disc" }}>
                        {item.hobbie}
                      </li>
                    );
                  })}
