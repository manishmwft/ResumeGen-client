        ...
        <>
          ...
          <div className="theme3">
            ...
            <div className="theme3-sec3">
              <div
                style={
                  !userdata.experience[0].company ? { gridColumn: "2/3" } : null
                }
              >
                {userdata.experience[0].company ? (
                  <div className="theme3-sec">
                    <div className="theme3-head" style={{ color: themeclr }}>
                      WORK EXPERIENCE
                    </div>
                    ...
                    {userdata.education.map((item, index) => {
                      return (
                        <div key={index}>
                          ...
                          <div
                            className="text-xs italic edu-grading"
                            style={{ color: themeclr }}
                          >
                            <div>
                                ...
                                (i, index) => {
                                  return (
                                    <React.Fragment key={index}>
                                      {item.rate < i ? (
                                        <div
                                          className="theme3-ratediv"
                                          style={{ color: themeclr }}
                                        >
                                          <div className="theme3-ratediv-inner"></div>
                                        </div>
                                      ) : (
                                        <div
                                          className="theme3-ratediv"
                                        ...
                                        >
                                          <div
                                            className="theme3-ratediv-inner"
                                            style={{
                                              color: themeclr,
