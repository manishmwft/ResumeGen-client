          ...
          <div className="theme4">
              ...
              <div className="theme4-sec">
                ...
                >
                  <CgShapeRhombus
                    ...
                    style={{ color: themeclr }}
                  />
                  <div className="theme4-head" style={{ color: themeclr }}>
                    SKILLS
                  </div>
                </div>
                  ...
                  <ul>
                    {userdata.personal.interest.map((item, index) => {
                      return (
                        <li
                          className={"ml-6"}
                          style={{ listStyle: "circle outside" }}
                          key={index}
                        >
                          {item.hobbie}
                        </li>
            ...
            <div className="theme4-sec2">
              <div>
                <div
                  className={"text-3xl"}
                  style={{ color: themeclr, fontWeight: "bold" }}
                >
                  {userdata.personal.name} {userdata.personal.lastname}
                </div>
                <div style={{ color: smallclr, fontSize: "15px" }}>
